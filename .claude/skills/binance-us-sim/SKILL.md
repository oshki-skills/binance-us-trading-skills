...
## Engine (sim.py — pure mock, no network, no keys)
    ...
    python scripts/sim.py --mode sim_run --strategy dip --scenario dip --budget 1000
    python scripts/sim.py --mode sim_run --scenario bull
    python scripts/sim.py --mode sim_run --scenario choppy --take-profit 4 --slice-usd 150
