...
Single order:
    ...
    python scripts/trading.py --mode preview_order --symbol BTCUSD --side BUY  --type MARKET --quote-usd 10
    python scripts/trading.py --mode place_order   --symbol BTCUSD --side BUY  --type LIMIT  --quote-usd 10 --price 64000
    python scripts/trading.py --mode place_order   --symbol SOLUSD --side SELL --type MARKET --pct 50

Multi-leg LIMIT plan (legs are JSON; each leg is its own validated limit order):

    python scripts/trading.py --mode preview_multi --legs '[
      {"symbol":"BTCUSD","side":"BUY","type":"LIMIT","quote_usd":7.5,"price":64000},
      {"symbol":"ETHUSD","side":"BUY","type":"LIMIT","quote_usd":7.5,"price":1800}]'
    python scripts/trading.py --mode place_multi   --legs '[ ...same shape... ]'
